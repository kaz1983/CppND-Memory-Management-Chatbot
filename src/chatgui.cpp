    ...
    : wxScrolledWindow(parent, id)
{
    ...
    // Task 1 - create chat logic instance using make_unique instead of new 
...
{
    // Task 1 - removed "delete _chatLogic" since memory management is now handled by the unique_ptr
}
